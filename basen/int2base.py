...
def int2base(inp: int, alphabet: str) -> str:
    """\
    Convert an integer to its string representation in a given base(lenght of alphabet).
...
def base2int(inp: str, alphabet: str) -> int:
    """\
    Convert an string representation to its integer in a given base(lenght of alphabet)
